...
export default function Screening() {
    ...
    const [data, setData] = useState({
        ...
        opEmailOpn: '',
        motifStatusOpn: '',
        screeningStatusOpnplusone: '',
        motifStatusOpnplusone: '',
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                setData(resultData);
                setMotif(resultData.motifStatusOpnplusone);
                setDecision(resultData.screeningStatusOpnplusone);
        ...
        if (decision) {
            ...
            if (decision === 'accepte') {
                submission = {
                    ...
                    SCREENING_STATUS_ID: 3  // Setting SCREENING_STATUS_ID to 1 for 'accepte'
                };
            } else if (decision === 'refuse') {
                submission = {
                    MOTIF_STATUS: motif,  
                    SCREENING_ID: screeningId,
                    SCREENING_STATUS_ID: 4  // Setting SCREENING_STATUS_ID to 2 for 'refuse'
                };
            }
    ...
    const submitHitRequest = (payload) => {
        ...
        fetch(`${import.meta.env.VITE_API_GATEWAY_URL
            }/v1/b2c/TreatmentScreening/OPNPlusOne/processTreatmentNplusOneRequest`
            , {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${auth?.access_token}`,
                            ...
                            <div className="row mx-1">
                                ...
                                <div className="col-md-12">
                                    <input
                                        type="radio"
                                        disabled="true"
                                        checked={data.screeningStatusOpn == '1'}
                                    />
                                    <label htmlFor="accepteee" className="form-label px-1"> Hit positif whitelist&eacute;</label>
                                </div>
                                <div className="col-md-12 mb-2">
                                    <input
                                        type="radio"
                                        disabled="true"
                                        checked={data.screeningStatusOpn == '2'}


                                    />
                                    <label htmlFor="refuseee" className="form-label px-1" > Hit positif bloqu&eacute;</label>
                                </div>
                            </div>
                            <div className="row mx-1">
                                <label htmlFor="datemotif" className="form-label"> <b> Date de d&eacute;cision niveau N </b></label>
                                <input type="text" className="form-control" id="dateValidation" value={data.dateStatusOpn ? data.dateStatusOpn.substring(0, 10) : ''} disabled />
                            </div>
                        </div>
                        <div className="col-md-6 px-2 " >
                            <div className="row mx-1">
                                ...
                                <textarea
                                    ...
                                    value={data.motifStatusOpn}
                                    disabled="true"

                                />
                            </div>
                            <div className="row mx-1">
                                <label htmlFor="motif" className="form-label"> <b> Email de l'OP en charge de la d&eacute;cision  </b></label>
                                <input type="text" className="form-control" id="emailVlidation" value={data.opEmailOpn} disabled />
                            </div>
                        </div>
                    ...
                    <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="col-md-6 mb-2">
                                        ...
                                        <div className="col-md-12">
                                            <input
                                                ...
                                                name="decision"
                                                value="accepte"
                                                disabled={isButtonDisabled || data.screeningStatusOpnplusone || !data.screeningStatusOpn}
                                                checked={decision == '3' || decision == 'accepte'}
                                        ...
                                        <div className="col-md-12 mb-2">
                                            <input
                                                ...
                                                value="refuse"
                                                disabled={isButtonDisabled || data.screeningStatusOpnplusone || !data.screeningStatusOpn}
                                                checked={decision == '4' || decision == 'refuse'}
                                                onChange={handleDecisionChange}
                        ...
                        <div className="row justify-content-center">
                            <div className="col-md-6 text-center">
                                <button type="submit" disabled={!decision || isButtonDisabled || data.screeningStatusOpnplusone || !data.screeningStatusOpn} className="btn custom-button">
